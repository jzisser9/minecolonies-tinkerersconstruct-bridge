...
@Mod(MineColoniesTConstructBridge.MODID)
public class MineColoniesTConstructBridge
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "minecolonies_tconstruct_bridge";
    ...
    public MineColoniesTConstructBridge()
    {
